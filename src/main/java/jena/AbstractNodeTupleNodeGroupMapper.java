 ...
 *            Writable tuple type
 */
public abstract class AbstractNodeTupleNodeGroupMapper<TKey, TValue, T extends AbstractNodeTupleWritable<TValue>> extends
        Mapper<TKey, T, NodeWritable, NodeWritable> {
